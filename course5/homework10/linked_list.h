...
//     // {
//     //     data = std::make_unique<T>(val);
//     //     next = std::make_unique<Node<T>>(next_node);
//     // }
//
...
//         next = std::make_unique<Node<T>>(src.next);
//     }
...
public:
    ...
    //     head = Node<T>(val);
    //     head.next = std::make_unique<Node<T>>(head);
    //
    //
    //     // head = Node<T>(val, head);
    //     std::cout << "Push front -- new head data: " << head.getData() << std::endl;
    //     std::cout << "Push front -- next data: " << head.next.get()->getData() << std::endl;
    //     mSize += 1;
    // }
    // void pop_front()
    // {
