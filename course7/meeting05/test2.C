...
# 98 "/usr/include/c++/5/bits/stl_stack.h" 3
  template<typename _Tp, typename _Sequence = deque<_Tp> >
    ...
    public:
      ...
      : c(__c) { }
# 148 "/usr/include/c++/5/bits/stl_stack.h" 3
      bool
      empty() const
      { return c.empty(); }
...
# 230 "/usr/include/c++/5/bits/stl_stack.h" 3
    };
...
# 262 "/usr/include/c++/5/bits/stl_stack.h" 3
  ...
  template<typename _Tp, typename _Seq>
    ...
    operator>=(const stack<_Tp, _Seq>& __x, const stack<_Tp, _Seq>& __y)
    { return !(__x < __y); }
# 303 "/usr/include/c++/5/bits/stl_stack.h" 3

}
# 62 "/usr/include/c++/5/stack" 2 3
# 4 "rpn_calculator.hh" 2
